...
template<int op_size, int psr_size, int mem_addr_size, int data_size> class alu: public sc_module
{
	...
	private:
		...
		void prc_c2()
		{
			_c2_out = c2.read() ? (sc_uint<data_size>)0 : _c1_out2.read();
			output_mar = _c2_out;
			output_con = _c2_out;
			_alu_in2 = _c2_out.read();
		}
		...
		void prc_c4()
		{
			_c4_out = c4.read() ? (sc_uint<data_size>)(_c3_out.read() ^ 0xFFFF)
								: _c3_out.read();
			inout_mdr = _c4_out;
			_alu_in1 = _c4_out.read();
		}

		void prc_c5()
		{
			_c5_out = c5.read() ? (bool)_c4_out.read()[data_size-1] : false;
		}
